...
public class Parser1Tests {
    ...
    public void testInterface2() throws Exception {
        ...
        tokens.add(new Token(Token.TokenTypes.WORD, 3, 13, "number"));
        tokens.add(new Token(Token.TokenTypes.WORD, 3, 20, "s"));
        tokens.add(new Token(Token.TokenTypes.COMMA, 3, 23));
        tokens.add(new Token(Token.TokenTypes.WORD, 3, 25, "number"));
        tokens.add(new Token(Token.TokenTypes.WORD, 3, 33, "s"));
        tokens.add(new Token(Token.TokenTypes.DEDENT, 3, 34));
        ...
        Assertions.assertEquals(1, tran.Interfaces.size());
        Assertions.assertEquals(2, tran.Interfaces.getFirst().methods.size());
        Assertions.assertEquals(2, tran.Interfaces.getFirst().methods.get(1).returns.size());
    }
}